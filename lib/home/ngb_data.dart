...
class NgbData {
  ...
  static List<Ngb> _getAllCategory() {
    ...
    category.add(Ngb(
        ...
        name: 'Singular',
        parent: '08096fbe-4e8a-47a1-bb0d-f37d8f51e2a5',
        ordem: 'Verbo - Singular',
        filter: ["ngb"]));
    category.add(Ngb(
        id: '705a027f-4c0a-49a4-9d61-0abd5b4e8d7e',
        name: 'Subjuntivo',
        parent: '08096fbe-4e8a-47a1-bb0d-f37d8f51e2a5',
        ordem: 'Verbo - Subjuntivo',
        filter: ["ngb"]));
    category.add(Ngb(
